...
category: tutorials
toc: true
heroImage: '../../content/post/_images/intro-to-intersection-observer/intersection-observer.jpg'
heroAlt: Pengantar Intersection Observer
lang: id
---
...
![Intersection Observer](../../content/post/_images/intro-to-intersection-observer/window.png)
