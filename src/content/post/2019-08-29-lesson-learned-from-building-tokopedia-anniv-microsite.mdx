...
category: experience
toc: true
heroImage: '../../content/post/_images/lesson-learned-from-building-tokopedia-anniv-microsite/tokopedia-anniv.png'
heroAlt: Pelajaran dari membangun microsite untuk Tokopedia Anniversary
lang: id
enready: true
---
...
![Desktop Web](../../content/post/_images/lesson-learned-from-building-tokopedia-anniv-microsite/anniv-desktop.gif)
