...
category: tools
toc: true
heroImage: '../../content/post/_images/open-web-perf-report-for-personal-blog/open-web-perf-report.jpg'
heroAlt: Laporan terbuka performa web untuk blog pribadi
lang: id
---
...
![Gambar tampilan dari halaman /speed di awal-awal](../../content/post/_images/open-web-perf-report-for-personal-blog/speed-page.png)
