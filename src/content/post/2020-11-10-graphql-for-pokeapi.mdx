...
category: tools
toc: true
heroImage: '../../content/post/_images/graphql-for-pokeapi/graphgql-pokeapi.png'
heroAlt: GraphQL untuk PokeApi
lang: id
---
...
![Contoh penggunaan GraphQL Playground](../../content/post/_images/graphql-for-pokeapi/query-graphql-pokeapi.png)
