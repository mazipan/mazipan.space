...
## Alternatif DB untuk frontend engineer
...
- NeonDB: Serverless DB yang punya free tier kecil bisa buat POC projek keci. [Vercel Postgres](https://vercel.com/docs/storage/vercel-postgres/usage-and-pricing) under the hood pakai NeonDB juga setahu saya.
...
## Fungsi untuk menghapus suatu baris
