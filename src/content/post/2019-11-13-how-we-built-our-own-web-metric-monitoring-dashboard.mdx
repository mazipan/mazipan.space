...
category: experience
toc: true
heroImage: '../../content/post/_images/how-we-built-our-own-web-metric-monitoring-dashboard/luke-chesser-JKUTrJ4vK00-unsplash.jpg'
heroAlt: Bagaimana kami membangun dashboard pemantau metrik web
lang: id
enready: true
---
...
![Laporan Pagespeed Insight](../../content/post/_images/how-we-built-our-own-web-metric-monitoring-dashboard/pagespeed-result.png)
