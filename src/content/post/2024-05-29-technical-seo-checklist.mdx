...
category: tutorials
toc: true
heroImage: '../../content/post/_images/technical-seo-checklist/pexels-thatguycraig000-1526857.jpg'
heroAlt: Daftar periksa teknikal SEO
lang: id
---
...
![Berbagai macam proses rendering beserta kelebihan dan kekurangannya](../../content/post/_images/technical-seo-checklist/rendering-tradeoff.png)

Meskipun sudah ada artikel yang menyebutkan bahwa [Crawler bisa menjalankan JavaScript di client](https://developers.google.com/search/docs/crawling-indexing/javascript/javascript-seo-basics), sehingga opsi menggunakan _full client side rendering (CSR)_ bisa saja diambil. Namun sebaiknya ini menjadi pilihan terakhir saja. Pun kalau Crawler dari mesin pencari bisa menjalankan JavaScript namun bisa jadi beberapa peralatan pengujian belum tentu bisa menjalankannya dengan baik sebaik yang Crawler lakukan. Akan ada kesenjangan yang bisa membingunkan untuk pengambilan keputusan di masa mendatang. Opsi terbaik tentu saja SSR atau opsi serupa yang tujuannya mengembalikan markup html langsung beserta konten yang dibutuhkan oleh Crawler.

### 🔖 Daftar Periksa: Rendering Halaman

- ✅ Memastikan halaman di render dengan benar
- ✅ Memastikan informasi penting telah di-_render_ bersamaan dengan HTML
...
- ✅ Memastikan semua meta tag di-_render_ dari server
- ✅ Memastikan sudah ada tag `<meta name="viewport"/>` yang tepat agar laman bisa responsive dengan perubahan lebar layar
- ✅ Memastikan sudah ada meta tag `<meta name="robots" />` yang memberikan akses pada crawler untuk meng-_index_ sebuah laman
- ✅ Memastikan hanya website dengan lingkungan production yang dibolehkan untuk di _index_
...
- ✅ Memastikan Structured Data di-_render_ bersamaan dengan HTML
...
- ✅ Memastikan telah me-_render_ semua Link dengan benar menggunakan tag `<a>` agar mudah dibaca oleh Crawler
...
- ✅ Me-_render_ gambar dengan tepat beserta `alt` atau caption yang dekriptif
...
- ✅ Bisakah menyematkan komponen Breadcrumb sebagai alat navigasi yang di-_render_ dengan tag `<a>`?
