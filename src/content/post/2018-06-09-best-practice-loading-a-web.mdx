...
category: tutorials
toc: true
heroImage: '../../content/post/_images/best-practice-loading-a-web/devtools.png'
heroAlt: Best practice dalam memuat halaman website
lang: id
---
...
![HTML Optimize](../../content/post/_images/best-practice-loading-a-web/html-opt.png)
