...
category: tutorials
toc: true
heroImage: '../../content/post/_images/kesalahpahaman-mengenai-code-splitting/pizza-slice.jpg'
heroAlt: Kesalahpahaman mengenai code splitting
lang: id
---
...
![Perpindahan Halaman di SPA](../../content/post/_images/kesalahpahaman-mengenai-code-splitting/spa-move-route.gif)
