...
category: tutorials
toc: true
heroImage: '../../content/post/_images/create-awesome-blog-with-gridsome/how-it-works.png'
heroAlt: Membuat blog keren dengan Gridsome
lang: id
enready: true
---
...
![Gridsome Logo](../../content/post/_images/create-awesome-blog-with-gridsome/logo-normal-dark.svg)
...
4. Kita bisa menambahkan gambar untuk artikel terkait pada direktori `/content/posts/images`, dan cukup menautkan dengan kode Markdown biasa seperti `![Gridsome Logo](../../content/post/_images/create-awesome-blog-with-gridsome/logo-normal-dark.svg)`
