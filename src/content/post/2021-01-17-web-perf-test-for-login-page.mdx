...
category: tutorials
toc: true
heroImage: '../../content/post/_images/web-perf-test-for-login-page/uji-performa-halaman-login.jpg'
heroAlt: Pengujian performa web untuk halaman dengan login
lang: id
---
...
![Gambar hasil uji PageSpeedInsight pada halaman yang membutuhkan login](../../content/post/_images/web-perf-test-for-login-page/test-login-page.png)
