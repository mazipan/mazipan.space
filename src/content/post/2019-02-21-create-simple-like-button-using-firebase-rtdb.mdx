...
category: tutorials
toc: true
heroImage: '../../content/post/_images/create-simple-like-button-using-firebase-rtdb/create-like-button-with-firebase-rtdb.jpg'
heroAlt: Membuat button Like sederhana menggunakan Firebase Realtime Database
lang: id
enready: true
---
...
![Button Like Firebase](../../content/post/_images/create-simple-like-button-using-firebase-rtdb/button-like-firebase.png)
...
```javascript title=plugins/firebase.js
import Vue from 'vue';
...
```javascript title=firebase-db-export.json
{
  "claps": {
