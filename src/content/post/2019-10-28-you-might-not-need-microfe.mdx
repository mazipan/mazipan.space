...
category: experience
toc: true
heroImage: '../../content/post/_images/you-might-not-need-microfe/microfe.png'
heroAlt: You might not need MicroFE
lang: id
enready: true
---
...
![Micro FE horizontal teams, source: martinfowler.com](../../content/post/_images/you-might-not-need-microfe/horizontal.png)
