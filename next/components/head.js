...
const Head = (props) => (
  <NextHead>
    ...
    <meta name="twitter:image" content={`${siteMeta.siteUrl}${props.ogImage || defaultOGImage}`} />
    <meta property="og:image" content={`${siteMeta.siteUrl}${props.ogImage || defaultOGImage}`} />
