        ...
        <Fragment>
          ...
          <div className="content">
            ...
            <p>
              ...
              I help kicking-off project for Vue.js documentation in Bahasa Indonesia with Vue.js ID community, you can check it on <a className="text-red-500" target="_blank" rel="noopener noreferrer" href="https://docs.vuejs.id/">https://docs.vuejs.id/</a>.
              I also help to built <a className="text-red-500" target="_blank" rel="noopener noreferrer" href="https://s.byphp.id/ajari-koding">https://s.byphp.id/ajari-koding</a> and <a className="text-red-500" target="_blank" rel="noopener noreferrer" href="https://s.byphp.id/learning">https://s.byphp.id/learning</a> for PHP ID community.
            </p>
          </div>
        </Fragment>
      </LayoutArticle>
