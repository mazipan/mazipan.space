...
export default function FloatingNav () {
  return (
    <nav className="md:hidden fixed w-full bottom-0 left-0 p-4 z-20 bg-gray-100 dark:bg-gray-900 flex items-center justify-between shadow-medium border-top-gradient">
